<?php
	...
	if(isset($_POST['btn-login'])) {
		...
		$res=mysql_query("SELECT * FROM student WHERE student_id='$studentid'");
...
<body>
	...
	<div id="content">
		<div id="top-msg">
			<h1 id="head" align="center" style="margin: 0px">Student Login</h1>
		</div>
		<div id="student-info">
			<form method="post" class="form-inline">
			<div id="student-info-input">
				<label class="sr-only" for="student-id">Username</label>
				<input class="form-control" id="student-id" placeholder="Student ID" type="text" name="studentid" required />
			</div>
			<div id="student-info-input">
			...
			<div id="student-info-input">
				<p><a href="create-student.php">New User?</a></p>
			</div>
		</div>
	</div> <!-- content -->
