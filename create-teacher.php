...
<?php
			...
			if(mysql_query("INSERT INTO teacher (username, first_name, last_name, password, active) VALUES ('$username', '$firstname', '$lastname', '$upass', true)")) {
?>
...
<body>
	...
	<div id="content">
		<div id="top-msg">
			<h1 id="head" align="center" style="margin: 0px">New Teacher Info</h1>
		</div>
		<div id="student-info">
			...
			<div id="student-info-input">
				<button type="submit" class="btn btn-default" id="student-info-btn" name="btn-signup">Create Teacher!</button>
			</div>
		</form>
		</div>
	</div> <!-- content -->
